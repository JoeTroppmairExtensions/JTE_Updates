		...
		<h5><?php echo JText::_('CC_EASY'); ?></h5>
			<div class="row">
				<div class="col-12 ms-md-5">
					<label class="btn btn-outline-success"><input type="checkbox" class="btn btn-sm btn-warning" onchange="checkAll(this)" consenty-toggle="" /> <?php echo JText::_('CC_TOGGLE_ALL'); ?></label>
				</div>
			</div>
		<hr/>
...
<div class="accordion-body">
		...
		<div class="row">
			...
			<div class="col-6">
				<p class="ms-3"><label><input type="checkbox" consenty-toggle="easybooking"><strong> <?php echo JText::_('CC_EASYBOOKING'); ?></strong></label></p>
			</div>
			<div class="col-6">
		...
		<div class="row">
			<div class="col-6">
				<p class="ms-3"><label><input type="checkbox" id="leaflet" consenty-toggle="leaflet"><strong> <?php echo JText::_('CC_LEAFLET'); ?></strong></label></p>
			</div>
			<div class="col-6">
...
<div class="accordion-body">
		<div class="row mt-2">
			<div class="col-6">
				<p class="ms-3"><label><input type="checkbox" consenty-toggle="webcams"><strong> <?php echo JText::_('CC_WEBCAMS'); ?></strong></label></p>
			</div>
			<div class="col-6">
...
<div class="accordion-body">
		...
		<div class="row mt-2">
			<div class="col-6">
				<p class="ms-3"><label><input type="checkbox" consenty-toggle="matomo"><strong> <?php echo JText::_('CC_MATOMO'); ?></strong></label></p>
			</div>
			<div class="col-6">
      ...
      <div class="modal-footer">
		<div class="row">
			<div class="col-6">
				<a href="<?php echo JText::_('CC_GOTO_GPDRLINK'); ?>"><?php echo JText::_('CC_GOTO_GPDR'); ?></a>
			</div>
			<div class="col-6">
...
function checkAll(myCheckBox) {
  ...
  if (myCheckBox.checked == true) {
    checkboxes.forEach(function(checkbox) {
	  ...
	  localStorage.setItem('consenty', '{"leaflet":1,"webcams":1,"matomo":1,"easybooking":1}');
    });
  } else {
    checkboxes.forEach(function(checkbox) {
