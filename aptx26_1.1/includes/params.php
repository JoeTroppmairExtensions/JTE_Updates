...
#$doc->addStyleSheet($tpath . '/css/cookieconsent.css');
...
#	if ($menu == "101") :
	if ( $this->countModules('startslider') ) :
		...
		$doc->addScript($tpath . '/js/start.js');
	endif;
$doc->addScript($tpath . '/js/float-panel.js');
#$doc->addScript($tpath . '/js/fslightbox.js');
#$doc->addScript($tpath . '/js/cookieconsent-init.js');
